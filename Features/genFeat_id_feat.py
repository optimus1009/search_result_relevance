...
import sys
import cPickle
from sklearn.preprocessing import LabelBinarizer   #Binarize labels in a one-vs-all fashion 所谓one-vs-all method就是将binary分类的方法应用到多类分类中
sys.path.append("../")
...
if __name__ == "__main__":
    ...
    for run in range(config.n_runs):
        ...
        for fold, (validInd, trainInd) in enumerate(skf[run]):  # run -> 0,1,2
