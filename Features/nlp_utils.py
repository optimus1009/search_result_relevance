...
def pos_tag_text(line,
    ...
    for name in ["query", "product_title", "product_description"]:
        ...
        ## nltk的工具集的off-the-shelf工具可以简单的对文本进行POS tagging
        ## eg： text = nltk.word_tokenize("And now for something completely different")
        ##      nltk.pos_tag(text)
...
class StemmedTfidfVectorizer(TfidfVectorizer):
    def build_analyzer(self):
		## TfidfVectorizer类，来自sklearn  ,具体信息参考下面的连接
		## http://scikit-learn.org/stable/modules/generated/sklearn.feature_extraction.text.TfidfVectorizer.html#sklearn.feature_extraction.text.TfidfVectorizer.build_analyzer
		## TfidfVectorizer.build_analyzer(): Return a callable that handles preprocessing and tokenization
